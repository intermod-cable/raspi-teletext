# Makefile for raspi-teletext NABTS
# Target: Raspberry Pi (BCM2835/6/7), NTSC composite output
...
CFLAGS += -DSTANDALONE -D__STDC_CONSTANT_MACROS -D__STDC_LIMIT_MACROS \
          ...
          -U_FORTIFY_SOURCE -Wall -Wextra -g \
